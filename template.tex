...
\acknowledgments{We thank Benjamin Isaac for the \emph{boiler} data set and Kristoffer Matheson and
  Ashley Spear for the \emph{foam} data set, collected through work supported by NSF grant
