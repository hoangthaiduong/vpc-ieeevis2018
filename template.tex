...
\teaser{
  ...
  \caption{Renderings of the \emph{Diffusivity} field at 0.2 bits per sample (bps), and its Laplacian field, at 1.0 bps, using two of the bit streams studied in the paper.Compared to the \emph{by bit plane} stream, \emph{by wavelet norm} produces a better reconstruction of the original function (left, see white features), but a worse reconstruction of the Laplacian field (right).}
  \label{fig:teaser}
}
