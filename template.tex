...
\title{A Study of the Tradeoff between Reduced Precision and Resolution for Scientific Data Analysis and Visualization}
...
\shortauthortitle{Hoang \MakeLowercase{\textit{et al.}}: A Study of the Tradeoff between Reduced Precision and Resolution for Scientific Data Analysis and Visualization}

%% Abstract section.
\abstract{Performing scientific analysis on large data commonly found nowadays is an onerous task
...
compared. The error patterns of these techniques are compared with regards to fundamental error metrics on function values (e.g., L2 norm),
...
\teaser{
  ...
  \caption{\emph{diffusivity}, 0.6 bps (Laplacian) and 0.1 bps (function)}
  \label{fig:teaser}
}
