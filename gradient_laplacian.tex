...
\begin{figure}[h]
	...
	{\includegraphics[width=0.23\linewidth]{img/gradient/gradient_0_diff.png}}
	{\includegraphics[width=0.23\linewidth]{img/gradient/gradient_1_diff.png}}
	{\includegraphics[width=0.23\linewidth]{img/gradient/gradient_2_diff.png}}
	{\includegraphics[width=0.23\linewidth]{img/gradient/gradient_3_diff.png}}}
	\subcaptionbox{by wavelet norm}{
	{\includegraphics[width=0.23\linewidth]{img/gradient/gradient_0.png}}
	{\includegraphics[width=0.23\linewidth]{img/gradient/gradient_1.png}}
...
\begin{figure}[h]
	...
	{\includegraphics[width=0.23\linewidth]{img/gradient/boiler-gradient.png}}
	{\includegraphics[width=0.23\linewidth]{img/gradient/boiler-groundtruth-gradient.png}}}
	\subcaptionbox{euler's gradient, 0.25 bps}{
	{\includegraphics[width=0.23\linewidth]{img/gradient/euler-gradient.png}}
	{\includegraphics[width=0.23\linewidth]{img/gradient/euler-groundtruth-gradient.png}}}
	\subcaptionbox{marschner-lobb's gradient, 1.55 bps}{
	{\includegraphics[width=0.23\linewidth]{img/gradient/marschner-lobb-gradient.png}}
	{\includegraphics[width=0.23\linewidth]{img/gradient/marschner-lobb-groundtruth-gradient.png}}}
	\subcaptionbox{diffusivity's gradient, 0.75 bps}{
	{\includegraphics[width=0.23\linewidth]{img/gradient/diffusivity-gradient.png}}
	{\includegraphics[width=0.23\linewidth]{img/gradient/diffusivity-groundtruth-gradient.png}}}
