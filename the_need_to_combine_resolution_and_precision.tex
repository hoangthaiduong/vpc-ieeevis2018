...
\hb{strongly suggest using Def environments to define different types of streams.. also, 
things like groups and chunks are easy to confuse... so def envs will allow refering back to them..
having a simple figure will help too. 
perhaps signature too should be defined explicitely, coz it is defined too late in a narrower context than i think it should}
...
\ptb{This description of the results feels very minimalistic to me ... afterall this discussion is
  the entire punch line for this section and why you made me read the rest. Also I can't read the
  text i nthe figures} It can be seen from Figure \ref{fig:motivation} that the streams that combine
...
\hb{this section is confusing..  it really discusses more than a need.. so perhaps Timo's idea of 
having task-independent vs task-dependent sections... or talk only about motivation here, but 
somehow combine 4.1 as well?}
