...
chunk size used in this paper is $4 \times 4 = 16$ bits;\ptb{Hmm, 4x4
  is not the chunk size but the group size ... at least if I
  underestand the definitions above correctly} TODO: we use
16x16 for data dependent streams).\ptb{Why do we use different group
  ...
  allow to better predict .....} This constraint is reasonable
