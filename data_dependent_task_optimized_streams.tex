...
makes only locally optimal choice. Similarl to the coarse-to-fine algorithm, the running time is still $O(n^3)$.
...
\begin{figure}
        \centering
        \caption{Compare the greedy coarse-to-fine with skip leading zeros}
\end{figure}


\begin{figure}
        \centering
        \caption{all three greedy schemes, the point to show here that $O(n^2)$
                 algorithm's results are close to the more expensive algorithm}
\end{figure}
