...
bits. $Q$ is an operation that transforms raw data fields (i.e., $f$ and $f'$) to some quantity of
...
simplified algorithm brings the running time down from days to minutes, while retaining the stream quality.
