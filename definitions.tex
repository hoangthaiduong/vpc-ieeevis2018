...
outweights any potential benefit. Despite that, we include them in our study for various reasons.
First, the \emph{by magnitude} scheme is well-known in the literature. Second, data-dependent
streams can serve as a benchmark to evaluate the performance of their data-independent counterparts.
Finally, in addition to being data-dependent, streams can also be task-dependent. Task-dependent
streams may provide insights on how data should be queried to perform certain analysis tasks.
