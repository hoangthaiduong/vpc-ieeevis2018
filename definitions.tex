...
precision of data. \todo{PL: Does a packet the improves resolution add the first bits of those samples/coefficients?  Need to make it clear what we mean by adding resolution, especially in the context of wavelets.} 
