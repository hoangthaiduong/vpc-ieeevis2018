...
In the third contribution, we consider the following analysis tasks: function reconstruction,
...
image (e.g., transfer function, camera position, resolution of the image, and rendering method),
making it less tractable to design a scientifically sound study with generalizable results.
