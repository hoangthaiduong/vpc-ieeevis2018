...
\item First, and perhaps most importantly, we present an in-depth study on the
  ...
  different points on the resolution-precision scale can be formed and compared. \pavol{I would not understand
  this last sentence if not read rest of paper}
