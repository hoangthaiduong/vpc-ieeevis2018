...
\caption{\pavol{what dataset is this?}Rendering of isosurfaces at isovalue of 0.2, at 0.7 bps. The surfaces are colored by the
...
resolution.\pavol{reword} Therefore, in order to obtain an accurate error measurement to
...
for the \emph{plasma} data set.\pavol{expand this sentence}
...
(see~\Cref{fig:isocontour-surfaces-pressure})\pavol{Fig 14 is after Fig 15 in text}. This figure renders the isosurfaces reconstructed at
