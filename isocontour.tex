...
\begin{figure}[!b]
\centering
 \subcaptionbox{\label{fig:bit-distrib-rmse-tile}\emph{RMSE signature}}{{\includegraphics[width=0.32\linewidth]{bit-distrib-rmse-tile}}}
 \subcaptionbox{\label{fig:bit-distrib-laplacian-tile}\emph{Laplacian signature}}{{\includegraphics[width=0.32\linewidth]{bit-distrib-laplacian-tile}}}
 \subcaptionbox{\label{fig:bit-distrib-histogram-tile}\emph{histogram signature}}{ {\includegraphics[width=0.32\linewidth]{bit-distrib-histogram-tile}}}
...
higher tolerance for differences in streams.~\Cref{fig:isocontour-surfaces-pressure} renders the
