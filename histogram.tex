...
\begin{figure}[h]
	\centering
	\subcaptionbox{\emph{boiler}, 256 bins}
	{\includegraphics[width=0.48\linewidth]{img/histogram/histogram-optimized-boiler.pdf}}
	\subcaptionbox{\emph{diffusivity}, 256 bins}
	{\includegraphics[width=0.48\linewidth]{img/histogram/histogram-optimized-diffusivity.pdf}}
	\subcaptionbox{\emph{euler}, 256 bins}
	{\includegraphics[width=0.48\linewidth]{img/histogram/histogram-optimized-euler.pdf}}
	\subcaptionbox{\emph{pressure}, 256 bins}
	{\includegraphics[width=0.48\linewidth]{img/histogram/histogram-optimized-pressure.pdf}}
	\subcaptionbox{\emph{turbulence}, 256 bins}
	{\includegraphics[width=0.48\linewidth]{img/histogram/histogram-optimized-turbulence.pdf}}
	\subcaptionbox{\emph{velocityz}, 256 bins}
