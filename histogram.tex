...
in~\Cref{fig:histogram-explain}. When leading zero packets are present, $s_{lvl}$ outperforms
...
significantly more than $s_{lvl}$ does (for the same reason explained in~\Cref{sec:rmse-optimized}),
...
\begin{figure*}[h]
	...
	{\includegraphics[width=0.24\linewidth]{histogram/histogram-optimized-plasma}}
	\subcaptionbox{\emph{turbulence}}
	{\includegraphics[width=0.24\linewidth]{histogram/histogram-optimized-turbulence}}
	...
	$s_{lvl}$ are explained in~\Cref{fig:histogram-explain}}.
