...
\hb{in general, a lot of text reads like ``we have tried this and this and that''. i think
the paper should only summarize the results. the process is of less meaning. this text 
should be made more focused on the point we're trying to make.}
