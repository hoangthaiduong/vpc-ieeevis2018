...
\begin{figure}[h]
	...
	{\includegraphics[width=0.31\linewidth]{rmse/rmse-boiler-level.png}}}
	\subcaptionbox{\emph{by bit plane}}{
	{\includegraphics[width=0.31\linewidth]{rmse/rmse-boiler-bit-plane.png}}}
	\subcaptionbox{\emph{by magnitude}}{
	{\includegraphics[width=0.31\linewidth]{rmse/rmse-boiler-magnitude.png}}}
	\subcaptionbox{\emph{by wavelet norm}}{
	{\includegraphics[width=0.31\linewidth]{rmse/rmse-boiler-wavelet-norm.png}}}
	\subcaptionbox{\emph{by signature}}{
	{\includegraphics[width=0.31\linewidth]{rmse/rmse-boiler-signature.png}}}
	\subcaptionbox{\emph{rmse-optimized}}{
	{\includegraphics[width=0.31\linewidth]{rmse/rmse-boiler-groundtruth.png}}}
