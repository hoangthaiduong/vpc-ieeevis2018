...
\begin{table*}[t]
  ...
  \hline
  boiler & combustion simulation& $218\times 130 \times 150$ & float64 & x & x & x & x & x & D(running) \\
  ...
  velocityz & hydrodynamics simulation& $256\times 256\times 256$ & float64 & x & x & x & x & x & D\\
	turbulence & fluid dynamics simulation& $256\times 256 \times 256$ & float32 & x & x & x & x & x &
	P(running)\\
	kingsnake & fluid dynamics simulation& $256\times 256 \times 256$ & float32 & x & x & x & x & x & D(done)\\
	...
	enzo-v & fluid dynamics simulation& $256\times 256 \times 256$ & float32 & x & x & x & x & x & D\\
	brain & fluid dynamics simulation& $256\times 256 \times 256$ & uint16 & x & x & x & x & x & P\\
	...
	karfs	& fluid dynamics simulation& $256\times 256 \times 256$ & float32 & x & x & x & x & x & D\\
  \hline
...
In \cref{fig:rmse-rendering} we volume render the \emph{plasma} data set at 0.1 bits per sample,
